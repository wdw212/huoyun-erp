...
export const queryParams = ref([
	{
		type: 'input',
		value: '',
		placeholder: '编号、提单号、目的港、分箱数据、备注',
		key: 'keyword'
	},
	{
		type: 'date',
	...
	},
	{
		type: 'select',
		value: '',
		placeholder: '请选择应收人民币',
		key: 'is_claimed',
		options: [
			{label: '应收人民币未兑付', value: '0'},
			{label: '应收人民币已兑付', value: '1'},
		]
	},
	{
		type: 'select',
		...
		key: 'is_claimed',
		options: [
			{label: '应收美金未兑付', value: '0'},
			{label: '应收美金已兑付', value: '1'},
		]
	},
	{
		type: 'select',
...
export const queryParamsInvoice = ref([
	{
		type: 'input',
		value: '',
		placeholder: '单号，单位，快递，寄件，发票，金额，备注',
		key: 'keyword'
	},
	{
		type: 'date',
		dateType: 'daterange',
		value: '',
		startPlaceholder: '申请时间开始时间',
		endPlaceholder: '申请时间结束时间',
		placeholder: '申请时间',
		key: 'start_sailing_dates'
	},
	{
...
const payCommonInfo = [
	...
	{
		label: '',
		soltLabel: 'PaymentBtn1',
		soltName: 'PaymentPayable1',
		// noShow: true,
		formItem: []
	},
	{
		label: '',
		soltLabel: 'PaymentBtn2',
		soltName: 'PaymentPayable2',
		// noShow: true,
		formItem: []
	},
	{
		label: '',
		soltLabel: 'PaymentBtn3',
		soltName: 'PaymentPayable3',
		// noShow: true,
		formItem: []
	},
	{
		label: '',
		soltLabel: 'PaymentBtn4',
		soltName: 'PaymentPayable4',
		// noShow: true,
		formItem: []
	},
	{
		label: '',
		soltLabel: 'PaymentBtn5',
		soltName: 'PaymentPayable5',
		// noShow: true,
		formItem: []
	},
	
]
export const paySureFromList = ref([
	{	
		tabName: '费用确认单',
		formData: [
			{
				label: '',
				formItem: [
					{ type: 'input',value: '',label: '委托人',placeholder: '请输入委托人',key: 'job_no', disabled: true, rules: rulesInit('请填写工作编号')},
					{ type: 'input',value: '',label: '合同号',placeholder: '请输入合同号',key: 'job_no', disabled: true, rules: rulesInit('请填写工作编号')},
					{ type: 'input',value: '',label: '工作编号',placeholder: '请输入工作编号',key: 'job_no', disabled: true, rules: rulesInit('请填写工作编号')},
					{ type: 'input',value: '',label: '起运港',placeholder: '请输入起运港',key: 'job_no', disabled: true, rules: rulesInit('请填写工作编号')},
					{ type: 'input',value: '',label: '目的港',placeholder: '请输入目的港',key: 'job_no', disabled: true, rules: rulesInit('请填写工作编号')},
					{ type: 'input',value: '',label: '开船日期',placeholder: '请输入开船日期',key: 'job_no', disabled: true, rules: rulesInit('请填写工作编号')},
					{ type: 'input',value: '',label: '提单号',placeholder: '请输入提单号',key: 'job_no', disabled: true, rules: rulesInit('请填写工作编号')},
					{ type: 'input',value: '',label: '船名/航次',placeholder: '请输入船名/航次',key: 'job_no', disabled: true, rules: rulesInit('请填写工作编号')},
					{ type: 'input',value: '',label: '到港日期',placeholder: '请输入到港日期',key: 'job_no',disabled: true, rules: rulesInit('请填写工作编号')}
				]
			}
		]
	},
...
//费用确认单
export const paySureList = ref([
	{label: '费用明细', type: 'edit', prop: 'cny_amount',
		form: {
			type: 'input',key: 'cny_amount',
		}
	},
	{label: '币种', type: 'edit', prop: 'cny_is_cashed',noShow:true,
		form: {
			type: 'select',key: 'cny_is_cashed',options: optionsComm['兑付'],clearable: false,
		}
	},
	
	{label: '单位', type: 'edit', prop: 'cny_invoice_number',width: '220px',
		form: {
			type: 'input',key: 'cny_invoice_number',popover:true
		}
	},
	{label: '数量', type: 'edit', prop: 'usd_amount',
		form: {
			type: 'input',key: 'usd_amount',
		}
	},
	{label: '单价', type: 'edit', prop: 'usd_invoice_number',width: '220px',
		form: {
			type: 'input',key: 'usd_invoice_number',popover:true
		}
	},
	{label: '总计', type: 'edit', prop: 'usd_is_cashed',noShow:true,
		form: {
...
//费用确认单
export const paySureList1 = ref([
	{label: '箱号', type: 'edit', prop: 'cny_amount',
		form: {
			type: 'input',key: 'cny_amount',
		}
	},
	{label: '柜型', type: 'edit', prop: 'cny_is_cashed',noShow:true,
		form: {
			type: 'select',key: 'cny_is_cashed',options: optionsComm['兑付'],clearable: false,
		}
	},
	
	{label: '总计', type: 'edit', prop: 'cny_invoice_number',width: '220px',
		form: {
			type: 'input',key: 'cny_invoice_number',popover:true
		}
	},

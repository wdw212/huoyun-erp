		...
		formData: [
			{
				...
				formItem: [
					...
					{ type: 'select',value: '',label: '起运港',placeholder: '请选择起运港',key: 'origin_harbor_id',rules: rulesInit('请选择起运港'), options: [],labelName: 'name', valueName: 'id', },
					{ type: 'select',value: '',label: '目的港',placeholder: '请选择目的港',key: 'destination_harbor_id',rules: rulesInit('请选择目的港'), options: [],labelName: 'name', valueName: 'id', },

...
export const queryParamsBusiness = ref([
	{
		type: 'input',
		value: '',
		placeholder: '工作编号，合同号，目的港，提单号，箱号，封号订舱信息及备注',
		key: 'keyword'
	},
	{
		type: 'date',
			...
			formData: [
				{
					...
					formItem: [
						...
						{ type: 'select',value: '',label: '操作员',placeholder: '请选择操作员',key: 'operate_user_id',options: [],rules: rulesInit('请选择操作员', 1),labelName: 'name', valueName: 'id',filterable: true },
						...
						{ type: 'select',value: '',label: '船公司',placeholder: '请选择船公司',key: 'shipping_company_id',options: [],labelName: 'name', valueName: 'id',filterable: true,rules: rulesInit('请选择船公司', 1), },
						...
						{ type: 'select',value: '',label: '截单状态',placeholder: '请选择截单状态',key: 'cutoff_status',options: optionsComm['截单状态'], defaultValue: 1,rules: rulesInit('请选择截单状态', 1) },
						...
						{ type: 'date',value: '',label: '开船日期',placeholder: '请选择开船日期',key: 'sailing_at', dateType: 'date' ,rules: rulesInit('请选择开船日期', 1)},
						{ type: 'date',value: '',label: '到港日期',placeholder: '请选择到港日期',key: 'arrival_at', dateType: 'date' ,rules: rulesInit('请选择到港日期', 1)},

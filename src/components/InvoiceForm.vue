...
如需打印费用单在下方上传，单子完结“是”后不能再增开发票，为此单结束。</div>
    <el-form label-width="120px">
            ...
            <el-col :span="12" style="flex: 0 0 44%;">
              <div class="section mb30">
                <el-form-item label="工作编号：" label-width="87px">
                  <el-input v-model="form.workNumber" style="width: 130px"  placeholder="HQ4-WHJ25002"/>
                </el-form-item>
          ...
          <el-col :span="7">
            <div class="section mb30">
              <el-form-item label="单子完结">
                ...
                <el-input v-model="form.number" style="width: 150px; margin-left: 20px" :disabled="form.isDisabled"/>
              </el-form-item>
      ...
      <!-- 大表格定义边框4*4-->
      <table border class="wrapper" style="width: 100%">
        <tbody>
        <tr>
            ...
            <div class="section">
              <el-form-item label="名称：" class="society">
                <el-select v-model="buyer.name" style="width: 350px" placeholder="请选择">
                  <el-option v-for="item in buyerOptions" :key="item.value" :label="item.label" :value="item.value" place />
                </el-select>
              </el-form-item>
            ...
            <div class="section">
              <el-form-item label="名称：" class="society">
                <el-select v-model="seller.name" style="width: 350px" placeholder="请选择">
                  <el-option v-for="item in sellerOptions" :key="item.value" :label="item.label" :value="item.value" place />
                </el-select>
              </el-form-item>
              <el-form-item label="统一社会信用代码：" class="society">
            ...
            <div class="section">
              <el-table :data="items" border style="width: 100%" fit show-summary sum-text="合计" :summary-method="getSummaries">
                ...
                <el-table-column width="80">
                  <template #header>
                    <el-button type="primary" @click="addRow" :disabled="items.length == 8 ? true : false">增行</el-button>
                  </template>
                ...
                <div class="total-btns">
                  ...
                  <div class="flex gap-4 items-center">
                    ...
                    <el-form-item label="人民币发票号：" >
                      <el-input v-model="rmbType" style="width: 180px" placeholder="25932000000029068754"/>
                    </el-form-item>
                  </div>
                </div>
                    ...
                    <div class="total-btns">
                      ...
                      <div class="flex gap-4 items-center">
                        ...
                        <el-form-item label="美金发票号：" >
                          <el-input v-model="dollarType" style="width: 180px" placeholder="25932000000029068754"/>
                        </el-form-item>
                      </div>
                    </div>
                </el-col>
...
const items = ref([{ name: '', unit: '', quantity: null, formattedValue: 0 }])
const itemss = ref([{ name: '', unit: '', quantity: null, formattedValue: 0 }])
...
const addRow = () => {
  if (items.value.length < 8) {
    items.value.push({ name: '', unit: '', quantity: null, formattedValue: 0 })
  }
}
const addRoww = () => {
  if (itemss.value.length < 8) {
    itemss.value.push({ name: '', unit: '', quantity: null, formattedValue: 0 })
  }
}
const delRow = (index) =>{

<template>
	<div class="pack-of-lading-draft">
						...
						<tr>
							<td colspan="4" rowspan="4">
								<div class="section">
									...
									<div class="area">
										<el-input v-model="textarea" :rows="2" type="textarea" placeholder="船名/航次" />
									</div>
		...
		<el-dialog v-model="dialogTableVisible" title="箱单预览" width="1150">
			<!-- <img v-if="previewImage" :src="previewImage" alt="Captured Image" style="max-width:950px" /> -->
					...
					<table>
						<tbody>
							...
							<tr>
									...
									<div class="section">
										...
										<p class="tit mt10">进箱开始时间：
											<!-- <el-date-picker v-model="form.startTime"
												type="datetime" :prefix-icon="null" style="width:160px"
												placeholder="开港时间" format="YYYY-MM-DD HH:mm" date-format="MMM DD, YYYY"
												time-format="HH:mm" /> -->
											{{form.startTime}}
										</p>
										<p class="tit mt10 mb10">进箱截止时间：
											<!-- <el-date-picker v-model="form.endTime"
												type="datetime" :prefix-icon="null" style="width:160px"
												placeholder="进港时间" format="YYYY-MM-DD HH:mm" date-format="MMM DD, YYYY"
												time-format="HH:mm" /> -->
											{{form.endTime}}
										</p>
									</div>
								...
								<td align="center">
									<div class="mtb5 tit">箱主:
										<!-- <el-input v-model="form.value4" style="width: 60px" placeholder="船公司" /> -->
										{{form.value4}}
										&nbsp;箱型:
										<!-- <el-input v-model="form.value5" style="width: 70px" placeholder="箱型" /> -->
										{{form.value5}}
									</div>
								</td>
							</tr>
							<tr>
								<td>
									<div class="mtb5 tit">EIR号:
										<!-- <el-input v-model="form.value6" style="width: 155px" placeholder="" /> -->
										{{form.value6}}
									</div>
								</td>
							</tr>
							<tr>
								<td>
									<div class="mtb5 tit">提箱堆场:
										<!-- <el-input v-model="form.value7" style="width: 135px" placeholder="提箱码头" /> -->
										{{form.value7}}
									</div>
								</td>
							</tr>
							<tr>
								<td>
									<div class="mtb5 tit">有效期:
										<!-- <el-date-picker v-model="form.endTime" :prefix-icon="null" type="datetime"
											style="width:155px" placeholder="条码有效期" format="YYYY-MM-DD HH:mm:ss"
							...
							<tr>
								<td colspan="4">Cont. size&type 箱型尺寸
									<p class="p10 mb10">
										<!-- <el-input v-model="form.value10" style="width:150px" placeholder="箱型" /> -->
										{{form.value10}}
									</p>
								</td>
							</tr>
							...
							<tr>
								<td colspan="4">
									<div class="section">
										<div>
											<div class="tit">Packing Date 装箱日期</div>
											<p class="ml10">
												<!-- <el-date-picker v-model="form.endTime2" type="datetime"
													placeholder="装柜时间" format="YYYY-MM-DD HH:mm:ss"
													date-format="MMM DD, YYYY" time-format="HH:mm" /> -->
												{{form.endTime2}}
											</p>
								...
								<td>Total Packages<br>总件数
									<p class="p10">
										<!-- <el-input v-model="form.value11" placeholder="总件数" /> -->
										{{form.value11}}
									</p>
								</td>
								<td>Total Cargo Wt<br>总货重
									<p class="p10">
										<!-- <el-input v-model="form.value12" placeholder="总货重" /> -->
										{{form.value12}}
									</p>
								</td>
								<td>Total Meas<br>总尺码
									<p class="p10">
										<!-- <el-input v-model="form.value13" placeholder="总体积" /> -->
										{{form.value13}}
									</p>
								</td>
								<td colspan="2" rowspan="2">
							...
							<tr>
								<td colspan="4">Received By Drayman<br>驾驶员签收及车号
									<p class="p10 ml10">
										<!-- <el-input v-model="form.value14" placeholder="司机信息" /> -->
										{{form.value14}}
									</p>
								</td>
								<td colspan="2">Cont. Tare Wt集装箱皮重</td>

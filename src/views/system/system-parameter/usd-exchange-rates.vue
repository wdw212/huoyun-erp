<template>
	<div class="app-container">
		...
		<el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
			...
			<el-table-column label="美金汇率" align="center" prop="exchange_rate" />
		...
		<el-dialog :title="title" v-model="open" width="500px" append-to-body>
			<el-form ref="formRef" :model="form" :rules="rules" label-width="80px">
				...
				<el-form-item label="美金汇率" prop="exchange_rate">
					<el-input v-model="form.exchange_rate" type="number" placeholder="请输入美金汇率" />
				</el-form-item>
			</el-form>
			<template #footer>
...
<script setup>
	import {
		...
		addData,
		updateData
	} from "@/api/system/system-parameter/usd-exchange-rates";

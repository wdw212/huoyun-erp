<template>
	<div class="app-container">
		...
		<el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
			...
			<el-table-column label="K值" align="center" prop="k_value" />
		...
		<el-dialog :title="title" v-model="open" width="500px">
			<el-form ref="formRef" :model="form" :rules="rules" label-width="80px">
				<el-form-item label="月份" prop="month_code">
					<!-- <el-input v-model="form.month_code" placeholder="请输入月份" /> -->
					<el-date-picker v-model="form.month_code" placeholder="请输入月份" value-format="YYYY-MM"
						type="month"></el-date-picker>
				</el-form-item>
				<el-form-item label="K值" prop="k_value">
					<el-input v-model="form.k_value" placeholder="请输入K值" />
				</el-form-item>
			</el-form>
			<template #footer>
...
<script setup>
	import {
		...
		addData,
		updateData
	} from "@/api/system/system-parameter/special-cost-rates";

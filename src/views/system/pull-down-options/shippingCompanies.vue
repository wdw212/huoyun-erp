<template>
	<div class="app-container">
		...
		<el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
			...
			<el-table-column label="免用箱天数" align="center" prop="free_container_days" />
			<el-table-column label="查货网址" align="center" prop="tracking_url" />
		...
		<el-dialog :title="title" v-model="open" width="500px" append-to-body>
			<el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
				...
				<el-form-item label="免用箱天数" prop="free_container_days">
					<el-input v-model="form.free_container_days" type="number" placeholder="请输入" />
				</el-form-item>
				<el-form-item label="查货网址" prop="tracking_url">

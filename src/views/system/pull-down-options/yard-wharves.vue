		...
		<el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
			...
			<el-table-column label="类型" align="center" prop="type">
				<template #default="scope">
					<el-tag v-if="scope.row.type === 0" type="success">预提</el-tag>
					<el-tag v-else type="danger">落箱</el-tag>
				</template>
			</el-table-column>
			...
			<el-form ref="formRef" :model="form" :rules="rules" label-width="80px">
				<el-form-item label="类型" prop="type">
					<el-select v-model="form.type" placeholder="请输入">
						<el-option label="预提" value="0" />
						<el-option label="落箱" value="1" />
					</el-select>
				</el-form-item>
...
<script setup>
	import {
		...
		addData,
		updateData
	} from "@/api/system/pull-down-options/yard-wharves";

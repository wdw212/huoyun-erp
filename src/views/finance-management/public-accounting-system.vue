<template>
	<div style="padding: 0 20px;">
		...
		<div style="padding: 8px;background-color: #f5f5f5;margin-top: 20px">
			<el-button type="primary" icon="Plus" @click="">添加自定义公账</el-button>
		</div>
		<el-table :data="tableData" border style="margin: 10px 0;" size="small">
			<el-table-column prop="title" label="自定义公账" />
		...
		<h4 style="margin: 20px 0 10px;font-weight: bold;">{{activeName}}公账</h4>
		<!-- 表格 -->
...
<script setup name="PublicAccountingSystem">
	import {
		ref,
		onMounted,
		h
	...
	const tableData3 = ref([
		{title: '公账人民币', number1: 0, number2: 0, total: 0},
		{title: '公账美金', number1: 0, number2: 0, total: 0},
	])
